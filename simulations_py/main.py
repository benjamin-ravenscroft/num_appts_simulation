...
if __name__ == "__main__":
    ...
    print(f"The approximate utilization with 200 appointments per week is {utilization:.3f}")
    ...
    for wait_flag in [True, False]:
        ...
        sim = Simulation(appts_per_week, 4, 52*4, True, patient_types, wait_flag=wait_flag)
